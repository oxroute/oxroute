...
<!-- <link href="/uteach/Public/css/bootstrap-theme.min.css" rel="stylesheet" type="text/css" />
<link href="/uteach/Public/css/bootstrap.css" rel="stylesheet" type="text/css" /> -->
...
/* 预览弹出屿*/       
		...
		.delete{ background:url(/uteach/Public/images/del_icon.png) no-repeat 47px center; padding-left:164px; padding-top:45px; color:#000;} 
...
<td style="width:267px">
	<div class="index_left" >
		<h1 class="bt_h1">
			...
			<?php if(is_array($subject)): $i = 0; $__LIST__ = $subject;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- <img src="/uteach/Public/images/index/dot2.png"  class="chem_btn"/> -->
...
<!-- 		<div class="shezhi">
			<span id="sz"><img src="/uteach/Public/images/index/sz.png" width="21" height="22" />
				<ul id="show2">
					<li><a href="###" class="add_dir">添加目录</a></li>
					<li class="nobor"><a href="#" class="dele">删除目录</a></li>
					<i><img src="/uteach/Public/images/index/dot11.png" width="13" height="8" /></i>
				</ul>
			</span>
		</div> -->
	</div>
	...
	<div class="bt_tit" >
		...
		<div class="name" style="top:23px;">
			<img src="/uteach/Public/images/index/logo.png" width="35" height="35" /> 
