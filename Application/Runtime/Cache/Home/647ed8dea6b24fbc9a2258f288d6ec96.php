...
<head>
    ...
    <link rel="Stylesheet" type="text/css" href="/uteach/Public/css/wCheck.css" />
	<script type="text/javascript" src="/uteach/Public/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/uteach/Public/js/wCheck.min.js"></script>
	<script type="text/javascript" src="/uteach/Public/js/zhujuan.js"></script>
</head>
<body>
	<div class="warp">
			...
			<p class="page_text">卷头</p>
				<div class="clear mar_L">
						<div class="xialai_xz" id="xialai1">
							...
							<img src="/uteach/Public/images/select_arrow.png" alt="">
							<div class="xia_list">
